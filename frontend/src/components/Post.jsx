    ...
    return (
        <div className='my-8 w-full max-w-sm mx-auto'>
            <div className='flex items-center justify-between'>
                ...
                <Dialog>
                    ...
                    <DialogContent className='flex flex-col items-center text-sm text-center'>
                        {
                            post?.author?._id !== user?._id && <Button variant='ghost' className='cursor-pointer text-[#ED4956] w-fit font-bold rounded-xl'>Unfollow</Button>

                        }
                        <Button variant='ghost' className='cursor-pointer w-fit rounded-xl'>Add to Favorites</Button>
                        {
                            user?._id &&
                            user?._id === post.author?._id &&
                            <Button onClick={deleteHandler} variant='ghost' className='cursor-pointer text-[#ED4956] w-fit font-bold rounded-xl'>Delete</Button>
            ...
            <div className='flex items-center justify-between my-2'>
                ...
                <CiBookmark onClick={bookmarkHandler} size={'22px'} className='cursor-pointer hover:text-gray-600' />
            </div>
